...
TELEGRAM_TOKEN = os.getenv("TELEGRAM_TOKEN_SIMPLE")  # второй токен
GEMINI_KEY = os.getenv("GEMINI_KEY")
PROXY_URL = os.getenv("PROXY_URL", "http://127.0.0.1:1081")

# Ваш основной промт (системная инструкция)
SYSTEM_PROMPT = """
...
async def handle_message(message: types.Message):
    try:
        # Отправляем запрос к Gemini с системным промтом
